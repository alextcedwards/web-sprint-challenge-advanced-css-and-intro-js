...
function get20s(array) {
  const newArray = [];
  for (let i = 0; i < array.length; i++) {
    let startYear = array[i].years.split(" - ")[0];
    let endYear = array[i].years.split(" - ")[1];
...
function addArtist(array) {
  const newArtist = {
    ...
    bio:
      "He could make 30 minute brownies in 20 minutes. He was such a good programmer that he solved world hunger.",
  };
