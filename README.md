...
1. How would you describe acessibility on the web to someone new to programming?
   ...
   Web accessibility means that websites are designed and developed so that people with disabilities can use them. More specifically, people can: perceive, understand, navigate, and interact with them more easily.

2. Talk about 3 different things you can do to ensure your website is accessible.

   Use semantic html, put descriptions in the alt tags of images, design for different devices and screens.

3. How would you explain the concept of a variable to someone new to programming?

   variables are data holders that are assigned values
